...
struct SettingsView: View {
    ...
    @AppStorage("roadsideattraction_showNotes") private var showNotes: Bool = true
    @AppStorage("roadsideattraction_compactList") private var compactList: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/attractlog-app/privacy.html")!)
                        .accessibilityIdentifier("settingsPrivacyLink")
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/attractlog-app/terms.html")!)
